...
\begin{itemize}
  ...
  \item The position of an enemy agent if it is within 5 squares of the agent or a teammate \todo{is it 5 squares or 5 manhattan distances?}
\end{itemize}
...
The agents will be able to move in four directions, up, down, left and right.  \todo{mention that not moving is also an option?}
...
There was an issue where they took about 4 minutes to initialize their agents instead of the agreed 15 seconds \todo{mention that this is on our computers}, and could thus be disqualified, but we agreed to let them participate in the tournament anyway. 
