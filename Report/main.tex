...
First, we will describe the experimental setup for the Pacman CTF game, and describe the process of running the experiments based on the rules agreed upon by all teams. Then, we will discuss the results of the experiments, and compare our solution to the other solutions proposed by the other teams.
...
\begin{table}[!hptb]
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    \textbf{6} & 5 & 1 & 3 & 16 \\
    \hline
    \textbf{\color{red}{3}} & \color{red}{3} & \color{red}{5} & \color{red}{2} & \color{red}{14} \\
    \hline
    \textbf{1} & 0 & 7 & 3 & 3 \\
    \hline
  \end{tabular}
...
\begin{table}[!hptb]
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    \textbf{6} & 7 & 2 & 6 & 23 \\
    \hline
    \textbf{\color{red}{3}} & \color{red}{4} & \color{red}{4} & \color{red}{6} & \color{red}{16} \\
    \hline
    \textbf{1} & 0 & 13 & 2 & 2 \\
    \hline
  \end{tabular}
